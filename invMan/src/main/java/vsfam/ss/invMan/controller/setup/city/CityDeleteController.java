...
@Controller
@RequestMapping("/setup/city/delete")
public class CityDeleteController extends SetupBaseController {
	...
	public String deleteCity(@PathVariable Long id, Model model,
		...
		try {
			...
			TransactionResult tr = this.cityService.deleteCity(id, principal.getName());
			...
			if (tr == null ) {
				...
				return "redirect:/setup/city/list/current";
